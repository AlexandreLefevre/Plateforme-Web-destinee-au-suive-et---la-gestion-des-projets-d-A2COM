...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<button type="button" name="unsuspendreprojet" class="btn btn-danger btn-xs unsuspendreprojet" id="'.$row["id"].'"><i class="fa fa-unlock" style="font-size:19px"></i></button>';
 $sub_array[] = '<button type="button" name="deleteprojet" class="btn btn-danger btn-xs deleteprojet" id="'.$row["id"].'"><i class="fa fa-trash" style="font-size:19px"></i></button>';
 $data[] = $sub_array;
}
